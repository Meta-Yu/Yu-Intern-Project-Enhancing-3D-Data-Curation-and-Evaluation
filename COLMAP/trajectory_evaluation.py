...
def compare_trajectory(category_name, scene_name, traj_est = None):
    ...
    gt_file_path = '/private/home/wangyu1369/COLMAP/poses_gt_est/{}_{}_gt.txt'.format(category_name, scene_name)
    est_file_path = '/private/home/wangyu1369/COLMAP/poses_gt_est/{}_{}_est.txt'.format(category_name, scene_name)
