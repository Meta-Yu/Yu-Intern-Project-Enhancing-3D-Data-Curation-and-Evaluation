...
def calculate_chamfer_distance(category_name, scene_name, background = False):
    if not background:
        est_file_path = '/private/home/wangyu1369/dust3r/estimated_point_clouds/dust3r_pcd_{}_{}_wobg.ply'.format(category_name, scene_name)
    else:
        est_file_path = '/private/home/wangyu1369/dust3r/estimated_point_clouds/dust3r_pcd_{}_{}_bg.ply'.format(category_name, scene_name)
    ...
    o3d.io.write_point_cloud("/private/home/wangyu1369/dust3r/estimated_point_clouds/dust3r_pcd_{}_{}_gt_new.ply".format(category_name, scene_name), 
                             target)
    
    if background:
        o3d.io.write_point_cloud("/private/home/wangyu1369/dust3r/estimated_point_clouds/dust3r_pcd_{}_{}_bg_new.ply".format(category_name, scene_name), 
                                source)
    else:
        o3d.io.write_point_cloud("/private/home/wangyu1369/dust3r/estimated_point_clouds/dust3r_pcd_{}_{}_wobg_new.ply".format(category_name, scene_name), 
                                source)
...
def calculate_chamfer_distance_new(category_name, scene_name, stride = 1):

    # est_file_path = '/private/home/wangyu1369/dust3r/estimated_point_clouds/dust3r_pcd_{}_{}.ply'.format(category_name, scene_name)


    est_file_path = "/private/home/wangyu1369/dust3r/estimated_point_clouds/visualization/dust3r_pcd_{}_{}_{}_frames.ply".format(category_name, scene_name, 202//stride + 1)
    ...
    # o3d.io.write_point_cloud("/private/home/wangyu1369/dust3r/estimated_point_clouds/visualization/dust3r_pcd_{}_{}_new.ply".format(category_name, scene_name), 
    #                             source)
...
if __name__ == '__main__':
        ...
        #     cd.append(calculate_chamfer_distance_new(category_name = cur_category_name, scene_name = cur_scene_name))
        # print(cd)
        # print(np.mean(cd))

            # print(calc_nn(category_name = cur_category_name, scene_name = cur_scene_name))
            calc_dcd(category_name = cur_category_name, scene_name = cur_scene_name)
