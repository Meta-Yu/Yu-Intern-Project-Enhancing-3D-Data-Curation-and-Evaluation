...
def get_ground_truth_pose(category_name, scene_name, stride= 1):
    ...
    file_path = '/private/home/wangyu1369/mast3r/poses_gt_est/{}_{}_gt.txt'.format(category_name, scene_name)
...
def save_est_traj(poses,category_name, scene_name):
    ...
    file_name = '/private/home/wangyu1369/mast3r/poses_gt_est/{}_{}_est.txt'.format(category_name, scene_name)
