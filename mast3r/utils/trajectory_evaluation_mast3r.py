...
def compare_trajectory(category_name, scene_name, traj_est = None):
    ...
    gt_file_path = '/private/home/wangyu1369/dust3r/poses_gt_est/{}_{}_gt.txt'.format(category_name, scene_name)
    est_file_path = '/private/home/wangyu1369/dust3r/poses_gt_est/{}_{}_est.txt'.format(category_name, scene_name)
...
if __name__ == '__main__':
    result_translation_part_ape_list = []
    result_rotation_part_ape_list = []
    ...
    "suitcase/102_11951_20633"
        ...
        result = compare_trajectory(category_name = cur_category_name, scene_name = cur_scene_name, stride = 100)
        # result_translation_part_ape_list.append(result[0])
        # result_rotation_part_ape_list.append(result[1])
        # print(result[0])
        # print(result_translation_part_ape_list, np.mean(result_translation_part_ape_list))
        # print(result_rotation_part_ape_list, np.mean(result_rotation_part_ape_list))
